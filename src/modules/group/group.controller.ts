...
import { GroupDTO, UpdateGroupDTO, queryDTO, CreateInterGroupDTO } from './dto/group.dto'
...
export class GroupController {
   ...
   @Post('/interGroup')
   async createInterGroup(@Res() res, @Body() createInterGroup: CreateInterGroupDTO ) {
     try {
       const create = await this.groupService.sendInvitation(createInterGroup)
       return res.status(HttpStatus.OK).json({
